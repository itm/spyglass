...
public class TestbedWizard extends Wizard {
    ...
    public boolean performFinish() {
        ...
        SpyglassApp.spyglass.setPacketReader(WSNPacketReader.createInstance(config.getSessionManagementUrl(),
    ...
    public class FirstPage extends WizardPage implements IExtendedWizardPage {
        ...
        public void createControl(Composite composite) {
            ...
            IObservableValue snaaUrlObservable = PojoObservables.observeValue(SWTObservables.getRealm(composite.getDisplay()), TestbedWizard.this.config, "snaaUrl");
            ...
            IObservableValue rsUrlObservable = PojoObservables.observeValue(SWTObservables.getRealm(composite.getDisplay()), TestbedWizard.this.config, "reservationUrl");
            ...
            context.bindValue(rsTextObservable, rsUrlObservable, new UpdateValueStrategy(UpdateValueStrategy.POLICY_UPDATE),
                    new UpdateValueStrategy(UpdateValueStrategy.POLICY_UPDATE));
            IObservableValue smUrlObservable = PojoObservables.observeValue(SWTObservables.getRealm(composite.getDisplay()), TestbedWizard.this.config, "sessionManagementUrl");
        ...
        public boolean isComplete() {
            return StringUtils.isNotBlank(snaaText.getText()) && StringUtils.isNotBlank(rsText.getText()) && StringUtils.isNotBlank(smText.getText());
        }
    }
