...
public class CheckboxErrorDialog extends ErrorDialog {
	 ...
	 *            the status object
	 */
	public CheckboxErrorDialog(final Shell parentShell, final String dialogTitle, final String message, final IStatus status) {
	 ...
	 *            the message to be displayed
	 * @param t
	 *            an object of the type {@link Throwable} or <code>null</code>
	 */
	public CheckboxErrorDialog(final Shell parentShell, final String dialogTitle, final String message, final Throwable t) {
		super(parentShell, dialogTitle, message, new Status(IStatus.ERROR, "unspecified ID", 0, "Status Error Message", t), IStatus.OK | IStatus.INFO
	 ...
	 * @param t
	 *            on object of the type {@link Throwable} or <code>null</code>
	...
	public static boolean openError(final Shell parent, final String dialogTitle, final String message, final Throwable t) {
		final CheckboxErrorDialog d = new CheckboxErrorDialog(parent, dialogTitle, message, new Status(IStatus.ERROR, "unspecified ID", 0,
				"Status Error Message", t));
		d.open();
