...
public class GridPainterPlugin extends BackgroundPainterPlugin {
	...
	@Override
	public PluginPreferencePage<GridPainterPlugin> createPreferencePage(final Widget parent, final ConfigStore cs) {
		return new GridPainterPluginPreferences(cs, this);
	}
	
	@Override
	public PluginPreferencePage<GridPainterPlugin> createTypePreferencePage(final Widget parent, final ConfigStore cs) {
