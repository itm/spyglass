...
// --------------------------------------------------------------------------------
/**
 * Logging facility. For configuration, a file named log4j.properties will be searched in the classpath in the package
 * specified in "propFileLocation". The syntax is available at the Apache log4j homepage
 * (http://jakarta.apache.org/log4j/).
 * 
 * @author Dennis Pfisterer, 2002
 */
public class Logging {
	private static final String propFileLocation = "de/uniluebeck/itm/spyglass/util/spyglass.log4j.properties";
	...
	/**
	 * Returns a log4j (http://jakarta.apache.org/log4j/) object for the supplied class name. The log4j framework is
	 * configured by a property file which can be customized by the user.
	 * 
	 * @param _name
	...
	/**
	 * Returns a log4j (http://jakarta.apache.org/log4j/) object for the supplied class. The log4j framework is
	 * configured by a propertiy file which can be customized by the user.
	 * 
	 * @param _obj
